...
import com.example.kioskosnacks.WebService.Services.ReportService;
...
public class ReportAdapter {
    private static ReportService API_SERVICE;

    private static final String BASE_URL = com.example.kioskosnacks.BuildConfig.API_URL;

    public static ReportService getApiService() {
        ...
        if (API_SERVICE == null) {
            ...
            API_SERVICE = retrofit.create(ReportService.class);
        }

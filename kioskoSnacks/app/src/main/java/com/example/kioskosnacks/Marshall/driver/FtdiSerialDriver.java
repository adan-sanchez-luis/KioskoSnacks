...
package com.example.kioskosnacks.Marshall.driver;
...
import com.example.kioskosnacks.Marshall.app.HexDump;
...
public class FtdiSerialDriver implements UsbSerialDriver {
    ...
    private class FtdiSerialPort extends CommonUsbSerialPort {
        ...
        private final int filterStatusBytes(byte[] src, byte[] dest, int totalBytesRead, int maxPacketSize) {
            ...
            int total = totalBytesRead - (packetsCount * 2);
/*
            int x = total;
            while (x > 2 && dest[x - 1] == 0 && dest[x - 2] == 0) {
                x--;
            }
            ...
            if (x != total) {
                ...
                Log.d(TAG, String.format("discarded %d bytes", total - x));
            }
*/
